...
export declare class StripePaymentService {
    private stripe;
    constructor();
    createCheckoutSession(price: any, email: any, name: any, phone: any): Promise<any>;
    createPortalSession(sessionId: string): Promise<string>;
    getAllCustomers(): Promise<Stripe.ApiList<Stripe.Customer>>;
    getCustomerTransactions(customerId: string): Promise<Stripe.ApiList<Stripe.PaymentIntent>>;
}
