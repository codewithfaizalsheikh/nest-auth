...
exports.PlanModule = PlanModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Plan', schema: plan_entity_1.PlanSchema }])],
        controllers: [plan_controller_1.PlanController],
        providers: [plan_service_1.PlanService, custom_logger_service_1.CustomLoggerService],
    })
], PlanModule);
